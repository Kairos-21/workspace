...
const DEFAULT_DATA = {
    ...
    _isNewUser: true,
    shortcuts: [
        { id: 's_folder_as', name: 'as', icon: '📁', type: 'folder', displayMode: 'preview', children: [], iconType: 'default' },
        ...
        { id: 's7', name: '微信', url: 'weixin://', icon: 'app_wechat', type: 'app', iconType: 'custom', customIconPath: '/images/icons/wechat.jpg' },
        { id: 's8', name: 'QQ', url: 'tencent://', icon: 'app_qq', type: 'app', iconType: 'custom', customIconPath: '/images/icons/qq.jpg' },
        { id: 's9', name: '飞书', url: 'feishu://', icon: 'app_feishu', type: 'app', iconType: 'custom', customIconPath: '/images/icons/feishu.jpg' }
    ],
    pomodoroSettings: {
        workDuration: 25,
        shortBreak: 5,
...
app.get('/api/favicon', async (req, res) => {
    ...
    try {
        ...
        console.log('[Favicon] 使用 Google favicon 服务:', googleFavicon);
        return res.json({
            success: true,
            data: { faviconUrl: googleFavicon, method: 'google' }
        });
